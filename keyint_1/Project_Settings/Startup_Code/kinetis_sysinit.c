...
void PORTE_Handler()
{
	if(PORTE_ISFR&0X04)  //按键按下该位后中断标志为1 
		{GPIOC_PDOR&=~0x01;}
	else
		GPIOC_PDOR|=0x01; 
	
	if(PORTE_ISFR&0X08)    //按键按下该位后中断标志为1 
		{ GPIOC_PDOR&=~0x02;}
	else
		GPIOC_PDOR|=0x02;	
...
void PORTB_Handler()
{
	if(PORTB_ISFR&0b100000000000000000)  //鎸夐敭鎸変笅涔嬪悗璇ヤ綅涓柇鏍囧織涓�  
	    {
		GPIOC_PDOR|=0xFFF;
		GPIOC_PDOR=~0x01;
	    }
	if(PORTB_ISFR& 0b10000000000000000)  //鎸夐敭鎸変笅涔嬪悗璇ヤ綅涓柇鏍囧織涓�  
		{
		GPIOC_PDOR|=0xFFF;
		GPIOC_PDOR=~0b000000001001;
		}
	if(PORTB_ISFR&      0b100000000000)  //鎸夐敭鎸変笅涔嬪悗璇ヤ綅涓柇鏍囧織涓�  
		{
		GPIOC_PDOR|=0xFFF;
		GPIOC_PDOR=~0b000001001001;
		}
	if(PORTB_ISFR&       0b10000000000)  //鎸夐敭鎸変笅涔嬪悗璇ヤ綅涓柇鏍囧織涓�  
		{
		GPIOC_PDOR|=0xFFF;
...
//	if(PORTB_ISFR&0X020)    //鎸夐敭鎸変笅涔嬪悗璇ヤ綅涓柇鏍囧織涓�
//		{ 
//		GPIOC_PDOR&=~0x0F;
//		GPIOC_PDOR&=~0x02;
//		GPIOC_PDOR&=~0x04;
...
//	}
	...
	PORTB_ISFR |= 0x00000FFF;  //Clear Port B  flags
//		PORTE_PCR2 |= 0x01000000;  //Another way to Clear Port E  flags
//		PORTE_PCR3 |= 0x01000000;
}
/**
